...
# Title
st.markdown('<p class="title">🎓 Student Performance Prediction</p>', unsafe_allow_html=True)
st.markdown('<p class="sub">Predict student academic performance using Machine Learning</p>', unsafe_allow_html=True)
